...
import { ChevronLeft, ChevronRight, Download, Plus, Search, Calendar as CalendarIcon, Sparkles } from 'lucide-react';
    ...
    return (
        <div style={{ position: 'relative' }}>
                        ...
                        {user && user.role === 'admin' && (
                            <>
                                <button
                                    ...
                                    title="Subir Agenda con IA"
                                >
                                    <Sparkles size={18} /> <span className="hidden sm:inline ml-2">Subir Agenda</span>
                                </button>
            ...
            <Modal
                ...
                title="Sincronizar Agenda con IA"
            >
                <AgendaUploadModal
                    onClose={() => setIsAgendaModalOpen(false)}
                />
